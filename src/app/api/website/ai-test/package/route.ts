...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const response = await gemini.models.generateContent({
      ...
      contents: `Generate a JSON object for a "${tourType}" travel package to "${destination}" for ${day} days
      ...
      - theme: Package category (adventure/luxury/family/cultural/nature)
    ...
    const { baseName, description, heroTitle, text, theme } = aiValidation.data;
